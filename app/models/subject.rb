class Subject < ActiveRecord::Base
  ...
  def self.make_subjects
    ...
    Subject.find_or_create_by!(title: 'Deck',                     x: 1300, y:   50, comments: 'Link to deck', stories: 1, terminal: 1, url: 'https://docs.google.com/presentation/d/1CTBOCE_X9nW4vw-wXbVe2eRn0vabxoVGwM9CcIi2yZs/edit#slide=id.p')
    ...
    Subject.find_or_create_by!(title: 'Unbiased change',          x: STORY_X_OFFSET + 1000, y:  350, comments: 'Metrics based', stories: 1)


    Subject.find_or_create_by!(title: 'Flexible planning',        x: STORY_X_OFFSET + 1200, y:  350, comments: 'Reacting to change', stories: 1, terminal: 1, url: '/#ap')
  end
end
