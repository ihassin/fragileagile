class Subject < ActiveRecord::Base
  ...
  def self.make_subjects
    ...
    Subject.find_or_create_by!(title: 'End-to-end',               x:  740, y:  350, comments: 'Reduce change sets to a minimum', stories: 1, url: 'https://docs.google.com/presentation/d/1XvPd-pKKGqpyd4IVLXUOghJqFDDIDsL9_Pc2wylEGnA/edit#slide=id.g14b2c42c09_0_0')

    Subject.find_or_create_by!(title: 'Rapid deployment',         x:  950, y:  350, comments: 'Any automation, including Unit, Integration, Functional, UI, Infra', stories: 1, url: '/#rapid')
    Subject.find_or_create_by!(title: 'Meaningful feedback',      x: 1200, y:  350, comments: 'Fan-in, fan-out, packaging, promotion', stories: 1, terminal: 1, url: '/#cl')

    Subject.find_or_create_by!(title: 'Monitoring',               x: 1080, y:  450, comments: 'Business monitors like server monitors', stories: 1, url: '/#semantic')
  end
end
